...
interface MessageDao {
    ...
    @Query("SELECT * FROM DataClass_MessageInfo WHERE sourceAndroidID = :androidID OR targetAndroidID = :androidID")
    fun getMessageByAndroidID(androidID: String): MutableList<DataClass_MessageInfo>
